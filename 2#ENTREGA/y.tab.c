...
case 3:
#line 52 "diy.y"
	{ yyval.n = binNode(tSTMT, binNode(tPUBeTIPO, yystack.l_mark[-5].n, yystack.l_mark[-4].n), binNode(tSTARMORE, yystack.l_mark[-3].n, binNode(tIDINIT, strNode(ID, yystack.l_mark[-2].s), yystack.l_mark[-1].n ))); }
break;
case 4:
#line 53 "diy.y"
	{ yyval.n = binNode(tSTMT1, binNode(tPUBeTIPO, yystack.l_mark[-8].n, yystack.l_mark[-7].n), binNode(tSTMTN, binNode(tSTMTSTARTID, yystack.l_mark[-6].n, strNode(ID, yystack.l_mark[-5].s)), binNode(tSTMTPRMTCORP, yystack.l_mark[-3].n, yystack.l_mark[-1].n))); }
break;
case 5:
#line 57 "diy.y"
	{ yyval.n = nilNode(tEND); }
...
case 58:
#line 151 "diy.y"
	{ yyval.n = binNode(tCALL, yystack.l_mark[-3].s, yystack.l_mark[-1].n); /*TODO*/}
break;
case 59:
#line 152 "diy.y"
	{ yyval.n = binNode(tCALL, yystack.l_mark[-2].s, nilNode(tEND)); }
break;
case 60:
#line 153 "diy.y"
	{ yyval.n = uniNode(UMINUS, yystack.l_mark[0].n); minusChecking(yystack.l_mark[0].n->info); yyval.n->info = yystack.l_mark[0].n->info;}
break;
case 61:
#line 154 "diy.y"
	{ yyval.n = uniNode(tPTR, yystack.l_mark[0].n); /*TODO*/ }
break;
case 62:
#line 155 "diy.y"
...
case 67:
#line 161 "diy.y"
	{ yyval.n = binNode(tMUL, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 68:
#line 162 "diy.y"
	{ yyval.n = binNode(tDIV, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 69:
#line 163 "diy.y"
	{ yyval.n = binNode(tMOD, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 70:
#line 164 "diy.y"
	{ yyval.n = binNode(tADD, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 71:
#line 165 "diy.y"
	{ yyval.n = binNode(tSUB, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 72:
#line 166 "diy.y"
	{ yyval.n = binNode(tLT, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 73:
#line 167 "diy.y"
	{ yyval.n = binNode(tGT, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 74:
#line 168 "diy.y"
	{ yyval.n = binNode(GE, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 75:
#line 169 "diy.y"
	{ yyval.n = binNode(LE, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 76:
#line 170 "diy.y"
	{ yyval.n = binNode(tEQ, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 77:
#line 171 "diy.y"
	{ yyval.n = binNode(NE, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntRealOrStr(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);}
break;
case 78:
#line 172 "diy.y"
