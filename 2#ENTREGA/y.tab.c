...
#line 101 "diy.y"
	{ yyval.n = binNode(tTIPOSTAR, yystack.l_mark[-2].n, binNode(tSTARID, yystack.l_mark[-1].n, strNode(ID, yystack.l_mark[0].s))); 
										IDnew (tipo->info + astOrNon->info, yystack.l_mark[0].s, 0); 
...
case 61:
#line 157 "diy.y"
	{ yyval.n = uniNode(tPTR, yystack.l_mark[0].n); isIntRealStrVoid(yystack.l_mark[0].n->info); yyval.n->info = £2>info; /*TODO*/ }
break;
case 62:
#line 158 "diy.y"
...
case 67:
#line 164 "diy.y"
	{ yyval.n = binNode(tMUL, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);  yyval.n->info = (yystack.l_mark[-2].n>yystack.l_mark[0].n) ? yystack.l_mark[-2].n : yystack.l_mark[0].n;}
break;
case 68:
#line 165 "diy.y"
	{ yyval.n = binNode(tDIV, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);  yyval.n->info = yystack.l_mark[-2].n>yystack.l_mark[0].n ? yystack.l_mark[-2].n : yystack.l_mark[0].n;}
break;
case 69:
#line 166 "diy.y"
	{ yyval.n = binNode(tMOD, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);  yyval.n->info = yystack.l_mark[-2].n>yystack.l_mark[0].n ? yystack.l_mark[-2].n : yystack.l_mark[0].n;}
break;
case 70:
#line 167 "diy.y"
	{ yyval.n = binNode(tADD, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info);  yyval.n->info = yystack.l_mark[-2].n>yystack.l_mark[0].n ? yystack.l_mark[-2].n : yystack.l_mark[0].n;}
break;
case 71:
#line 168 "diy.y"
	{ yyval.n = binNode(tSUB, yystack.l_mark[-2].n, yystack.l_mark[0].n); areIntOrReal(yystack.l_mark[-2].n->info, yystack.l_mark[0].n->info); yyval.n->info = yystack.l_mark[-2].n>yystack.l_mark[0].n ? yystack.l_mark[-2].n : yystack.l_mark[0].n;}
break;
case 72:
#line 169 "diy.y"
