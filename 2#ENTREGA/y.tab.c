...
case 35:
#line 120 "diy.y"
	{ yyval.n = binNode(WHILE, yystack.l_mark[-3].n, yystack.l_mark[-1].n); ciclos++; }
break;
case 36:
#line 121 "diy.y"
...
case 39:
#line 124 "diy.y"
	{ yyval.n = uniNode(BREAK, yystack.l_mark[-1].n); if(!ciclos)yyerror("Break must be in a cycle"); 	else ciclos--; }
break;
case 40:
#line 125 "diy.y"
	{ yyval.n = uniNode(CONTINUE, yystack.l_mark[-1].n); if(!ciclos)yyerror("Continue must be in a cycle"); else ciclos--; }
break;
case 41:
#line 126 "diy.y"
